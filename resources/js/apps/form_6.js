...
{	
	...
	/*Penyesuaian*/
	{
		...
		var input_1109_1_0	= parseFloat($(".input_1109_1-0").val()) || 0;
		var input_1109_2_0	= parseFloat($(".input_1109_2-0").val()) || 0;
		var input_1109_3_0	= parseFloat($(".input_1109_3-0").val()) || 0;
	...
	// Bobot Rekonsilasi
	{
		...
		console.log ("Nilai Pasar Properti: ", input_1115_0, input_1105_0);
		...
		$('#nilai_pasar_tanah,#nilai_pasar_bangunan').val(input_1116_3).addClass("text-right").number( true, 0 ).trigger("change")
		...
		if(input_1117_3 >= 20 && input_1117_3 <= 40)
		{
			...
			$('#nilai_likuidasi_tanah,#nilai_likuidasi_bangunan').val(input_1118_3).addClass("text-right").number( true, 0 ).trigger("change")
		}
		else
		{
			...
			var input_1118_3 = input_1116_3 * ((100 / 100) - (input_1117_3/100));
			$(".input_1118_3").val(0).attr("readonly", true).addClass("readonly").addClass("text-right").number( true, 0 ) //.trigger("change");
...
{	
	...
	for(var i = 0; i <= jumlah_pembanding ; i++)
	{
		...
		$(".input_1109_" + i + "-0").addClass("text-center").css("background-color", "white").parent().css("background-color", "white");
...
function hitung_luas_fisik_bangunan(role)
{
	...
	console.log ( luas_teras, luas_bangunan, total_ruas_bangunan);

	$("#" + role).find("input#textbox_bangunan_130").val(total_ruas_bangunan).attr("readonly", true).addClass("readonly").trigger("change");
...
function calculate_faktor_penentu_nilai_properti(role)
{
	var input_2067_ = parseFloat($('#'+role).find('.input_2067_').val()) || 0;
	var input_2068_ = parseFloat($('#'+role).find('.input_2068_').val()) || 0;
	var input_2069_ = parseFloat($('#'+role).find('.input_2069_').val()) || 0;
	var input_2070_ = parseFloat($('#'+role).find('.input_2070_').val()) || 0;
	var input_2071_ = parseFloat($('#'+role).find('.input_2071_').val()) || 0;

	var input_2072_ = input_2067_ + input_2068_ + input_2069_ + input_2070_ + input_2071_;

	$('#'+role).find('.input_2072_').val(input_2072_).number(0, true);
}

$(document).on("change", ".input_2067_, .input_2068_, .input_2069_, .input_2070_, .input_2071_", function(event){
	event.preventDefault();
	var role = $(this).attr('data-keterangan');
	calculate_faktor_penentu_nilai_properti(role)
});
