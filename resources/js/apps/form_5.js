...
$(document).ready(function(){
	...
	$("#textbox_bangunan_55, #textbox_bangunan_186").number( true, 0 )	
	$(".btn-tambah-bangunan").hide();
});
...
$(document).on("change", ".table_input", function()
{
	...
	if (id_field != undefined || id_field != "")
	{
		$.ajax({
			type		: "POST",
			url 		: base_url + "AjaxPekerjaan/update_textbox_kertas_kerja?id_kertas_kerja="+id_kertas_kerja,
			data		: {
				id_lokasi 	: id_lokasi,
				id_field	: id_field,
				value		: value,
...
function update_sarana_pelengkap()
{
	...
	// Total RCN & Nilai Pasar
	{
		...
		$("#textbox_sarana_88").val(total_rcn).attr("readonly", true).addClass("readonly").addClass("text-right").number( true, 0 )	//.trigger("change");
		$("#textbox_sarana_89").val(total_pasar).attr("readonly", true).addClass("readonly").addClass("text-right").number( true, 0 ).trigger("change");
...
function calculate_tab_pembanding()
{
	...
	// /*Penyesuaian*/
		...
		// 	var input_976_1_0	= parseFloat($(".input_976_1-0").val()) || 0;
		// 	var input_976_2_0	= parseFloat($(".input_976_2-0").val()) || 0;
		// 	var input_976_3_0	= parseFloat($(".input_976_3-0").val()) || 0;
		...
		// 	var input_975_1_0	= parseFloat($(".input_975_1-0").val()) || 0;
		// 	var input_975_2_0	= parseFloat($(".input_975_2-0").val()) || 0;
		// 	var input_975_3_0	= parseFloat($(".input_975_3-0").val()) || 0;
	...
	/*Penyesuaian*/
	{
		...
		var input_277_2_2	= input_277_2_0 * input_276_2 / 100;
		var input_277_3_2	= input_277_3_0 * input_276_3 / 100;
		var input_277_1_3	= input_277_1_2 * input_261_1;
		var input_277_2_3	= input_277_2_2 * input_261_2;
		var input_277_3_3	= input_277_3_2 * input_261_3;
		...
		var input_278_2_2	= input_278_2_0 * input_276_2 / 100;
		var input_278_3_2	= input_278_3_0 * input_276_3 / 100;
		var input_278_1_3	= input_278_1_2 * input_261_1;
		var input_278_2_3	= input_278_2_2 * input_261_2;
		var input_278_3_3	= input_278_3_2 * input_261_3;
		...
		var input_279_2_2	= input_279_2_0 * input_276_2 / 100;
		var input_279_3_2	= input_279_3_0 * input_276_3 / 100;
		var input_279_1_3	= input_279_1_2 * input_261_1;
		var input_279_2_3	= input_279_2_2 * input_261_2;
		var input_279_3_3	= input_279_3_2 * input_261_3;
		...
		var input_280_2_2	= input_280_2_0 * input_276_2 / 100;
		var input_280_3_2	= input_280_3_0 * input_276_3 / 100;
		var input_280_1_3	= input_280_1_2 * input_261_1;
		var input_280_2_3	= input_280_2_2 * input_261_2;
		var input_280_3_3	= input_280_3_2 * input_261_3;
		...
		var input_281_2_2	= input_281_2_0 * input_276_2 / 100;
		var input_281_3_2	= input_281_3_0 * input_276_3 / 100;
		var input_281_1_3	= input_281_1_2 * input_261_1;
		var input_281_2_3	= input_281_2_2 * input_261_2;
		var input_281_3_3	= input_281_3_2 * input_261_3;
		...
		var input_283_2_1	= input_283_2_0 * input_276_2 / 100;
		var input_283_3_1	= input_283_3_0 * input_276_3 / 100;
		var input_283_1_2	= input_283_1_1 * input_261_1;
		var input_283_2_2	= input_283_2_1 * input_261_2;
		var input_283_3_2	= input_283_3_1 * input_261_3;
		...
		var input_284_2_1	= input_284_2_0 * input_276_2 / 100;
		var input_284_3_1	= input_284_3_0 * input_276_3 / 100;
		var input_284_1_2	= input_284_1_1 * input_261_1;
		var input_284_2_2	= input_284_2_1 * input_261_2;
		var input_284_3_2	= input_284_3_1 * input_261_3;
		...
		var input_285_2_2	= input_285_2_0 * input_276_2 / 100;
		var input_285_3_2	= input_285_3_0 * input_276_3 / 100;
		var input_285_1_3	= input_285_1_2 * input_261_1;
		var input_285_2_3	= input_285_2_2 * input_261_2;
		var input_285_3_3	= input_285_3_2 * input_261_3;
		...
		var input_286_2_2	= input_286_2_0 * input_276_2 / 100;
		var input_286_3_2	= input_286_3_0 * input_276_3 / 100;
		var input_286_1_3	= input_286_1_2 * input_261_1;
		var input_286_2_3	= input_286_2_2 * input_261_2;
		var input_286_3_3	= input_286_3_2 * input_261_3;
		...
		var input_976_2_2	= input_976_2_0 * input_276_2 / 100;
		var input_976_3_2	= input_976_3_0 * input_276_3 / 100;
		var input_976_1_3	= input_976_1_2 * input_261_1;
		var input_976_2_3	= input_976_2_2 * input_261_2;
		var input_976_3_3	= input_976_3_2 * input_261_3;
		...
		var input_975_2_2	= input_975_2_0 * input_276_2 / 100;
		var input_975_3_2	= input_975_3_0 * input_276_3 / 100;
		var input_975_1_3	= input_975_1_2 * input_261_1;
		var input_975_2_3	= input_975_2_2 * input_261_2;
		var input_975_3_3	= input_975_3_2 * input_261_3;
		...
		var input_287_2_2	= input_287_2_0 * input_276_2 / 100;
		var input_287_3_2	= input_287_3_0 * input_276_3 / 100;
		var input_287_1_3	= input_287_1_2 * input_261_1;
		var input_287_2_3	= input_287_2_2 * input_261_2;
		var input_287_3_3	= input_287_3_2 * input_261_3;
		...
		var input_288_2_1	= input_288_2_0 * input_276_2 / 100;
		var input_288_3_1	= input_288_3_0 * input_276_3 / 100;
		var input_288_1_2	= input_288_1_1 * input_261_1;
		var input_288_2_2	= input_288_2_1 * input_261_2;
		var input_288_3_2	= input_288_3_1 * input_261_3;
...
function calculate_tab_pembanding_2()
{
	...
	var tanah 				= parseFloat($("#textbox_pembanding_15").val()) || 0;
	var harga				= parseFloat($("#textbox_pembanding_46").val()) || 0;

	//console.clear();
	console.log ("LUAS TANAH: ", tanah, "HARGA: ", harga);
	...
	// console.log (lik,$("#textbox_pembanding_102").length);
	if (dep<=19 || dep>=51)
	{
...
function style_after_ajax_pembanding()
{
	...
	for(var i = 0; i <= jumlah_pembanding ; i++)
	{
		...
		$(".input_975_" + i + "-0").addClass("text-center").css("background-color", "white").parent().css("background-color", "white");
		$(".input_976_" + i + "-0").addClass("text-center").css("background-color", "white").parent().css("background-color", "white");
...
function hitung_bct_bangunan(role)
{
	...
	$("#" + role).find("input#textbox_bangunan_82").val(intYear).attr("readonly", true).addClass("readonly")	//.trigger("change");
	$("#" + role).find("input#textbox_bangunan_83").val($("#" + role).find("input#textbox_bangunan_22").val()).attr("readonly", true).addClass("readonly")	//.trigger("change");
	$("#" + role).find("input#textbox_bangunan_84").val($("#" + role).find("input#textbox_bangunan_23").val()).attr("readonly", true).addClass("readonly") .trigger("change");
	...
	$("#" + role).find("input#textbox_bangunan_61").val(luas_bangunan).attr("readonly", true).addClass("readonly")	//.trigger("change");
	
	$("#" + role).find("input#textbox_bangunan_103").val(penyusutan_fisik).attr("readonly", true).addClass("readonly")	//.trigger("change");
	$("#" + role).find("input#textbox_bangunan_104").val(keusangan_fungsional).attr("readonly", true).addClass("readonly")	//.trigger("change");
	$("#" + role).find("input#textbox_bangunan_105").val(keusangan_ekonomis).attr("readonly", true).addClass("readonly")	//.trigger("change");
	$("#" + role).find("input#textbox_bangunan_106").val(total_penyusutan).attr("readonly", true).addClass("readonly")	//.trigger("change");
	
	var luas_imb		= parseFloat($("#" + role).find("input#textbox_bangunan_9").val()) || 0;
	var perbedaan_luas	= luas_bangunan - luas_imb;
	$("#" + role).find("input#textbox_bangunan_10").val(Math.abs(perbedaan_luas)).attr("readonly", true).addClass("readonly")	//.trigger("change");
	...
	var e = a + b + c + d
	$("#" + role).find("input#textbox_bangunan_20").val(e).attr("readonly", true).addClass("readonly").attr("readonly", true).addClass("readonly")	//.trigger("change");
	...
	$.ajax({
		...
		success		: function (data) {
			$("#" + role).find("input#textbox_bangunan_66").val(data.harga_pondasi_struktur).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_70").val(data.harga_rangka_penutup).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_74").val(data.harga_plafond).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_77").val(data.harga_dinding_pintu).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_81").val(data.harga_lantai_utilitas).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_87").val(data.rcn_bangunan).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			
			
			$("#" + role).find("input#textbox_bangunan_90").val(data.ket_teras).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_91").val(data.harga_teras).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_94").val(data.ket_balkon).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_95").val(data.harga_balkon).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_96").val(data.rcn_teras_balkon).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_97").val(data.rcn_bangunan2)	.addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly") //.trigger("change");
			$("#" + role).find("input#textbox_bangunan_98").val(data.pembulatan_rcn).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			
			$("#" + role).find("input#textbox_bangunan_85").val(data.umur_ekonomis).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_86").val(data.umur_efektif).attr("readonly", true).addClass("readonly")	//.trigger("change");

			$("#" + role).find("input#textbox_bangunan_107").val(data.kondisi_bangunan_persen).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_108").val(data.kondisi_bangunan).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_109").val(data.rcn_rp).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_110").val(data.rcn_rp_m).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_111").val(data.nilai_pasar).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_112").val(data.nilai_pasar2).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			
			// $("#" + role).find("input#textbox_bangunan_55").val(data.nilai_pasar2).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			
			var nilai_pasar_luquidasi	= data.nilai_pasar2 - (data.nilai_pasar2 * 30 / 100);
			
			$("#" + role).find("input#textbox_bangunan_56").val(nilai_pasar_luquidasi).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			...
			$("#" + role).find("input#textbox_bangunan_57").val(nilai_resmi_pasar).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
			$("#" + role).find("input#textbox_bangunan_58").val(nilai_resmi_pasar_luquidasi).addClass("text-right").number( true, 0 ).attr("readonly", true).addClass("readonly")	//.trigger("change");
