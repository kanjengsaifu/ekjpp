var data_bangunan	= new Array();
	...
	$(document).on("change", ".table_input", function()
	{
		...
		var value		= $(this).val();
		var id_tanah 	= $(this).attr('data-id-tanah');
		...
		// 		},
		// 		success		: function (data) {
		// 			//console.log ( id_lokasi, id_field, value, keterangan );
...
function calculate_tab_pembanding()
{
	...
	// Bobot Rekonsilasi
	{
		...
		$(".input_291_1").val(rekonsiliasi_1 * 100).number(true, 2).trigger('change');
		$(".input_291_2").val(rekonsiliasi_2 * 100).number(true, 2).trigger('change');
		$(".input_291_3").val(rekonsiliasi_3 * 100).number(true, 2).trigger('change');
