...
{	
	{
		...
		// var input_1102_1 = parseInt($(".input_261_1").val());
	...
	/*Penyesuaian*/
	{
		var input_1103_1_0	= parseInt($(".input_1103_1-0").val());
		var input_1103_2_0	= parseInt($(".input_1103_2-0").val());
		var input_1103_3_0	= parseInt($(".input_1103_3-0").val());
		...
		var input_1104_1_0	= parseInt($(".input_1104_1-0").val());
		var input_1104_2_0	= parseInt($(".input_1104_2-0").val());
		var input_1104_3_0	= parseInt($(".input_1104_3-0").val());
		...
		var input_1105_1_0	= parseInt($(".input_1105_1-0").val());
		var input_1105_2_0	= parseInt($(".input_1105_2-0").val());
		var input_1105_3_0	= parseInt($(".input_1105_3-0").val());
		...
		var input_1106_1_0	= parseInt($(".input_1106_1-0").val());
		var input_1106_2_0	= parseInt($(".input_1106_2-0").val());
		var input_1106_3_0	= parseInt($(".input_1106_3-0").val());
		...
		var input_1107_1_0	= parseInt($(".input_1107_1-0").val());
		var input_1107_2_0	= parseInt($(".input_1107_2-0").val());
		var input_1107_3_0	= parseInt($(".input_1107_3-0").val());
		...
		var input_1108_1_0	= parseInt($(".input_1108_1-0").val());
		var input_1108_2_0	= parseInt($(".input_1108_2-0").val());
		var input_1108_3_0	= parseInt($(".input_1108_3-0").val());
		...
		var input_1109_1_0	= parseInt($(".input_1109_1-0").val());
		var input_1109_2_0	= parseInt($(".input_1109_2-0").val());
		var input_1109_3_0	= parseInt($(".input_1109_3-0").val());

		var input_1109_1_2	= input_1109_1_0 * input_1102_1 / 100;
		var input_1109_2_2	= input_1109_2_0 * input_1102_2 / 100;
		var input_1109_3_2	= input_1109_3_0 * input_1102_3 / 100;
		var input_1109_1_3  = input_1109_1_2 * input_260_1;
		var input_1109_2_3  = input_1109_2_2 * input_260_2;
		var input_1109_3_3  = input_1109_3_2 * input_260_3;

		$(".input_1109_1-2").val(input_1109_1_2).trigger('change');
		$(".input_1109_2-2").val(input_1109_2_2).trigger('change');
		$(".input_1109_3-2").val(input_1109_3_2).trigger('change');	
		$(".input_1109_1-3").val(input_1109_1_3).trigger('change');
		$(".input_1109_2-3").val(input_1109_2_3).trigger('change');
		$(".input_1109_3-3").val(input_1109_3_3).trigger('change');	

		var input_1110_1_0	= parseInt($(".input_1110_1-0").val());
		var input_1110_2_0	= parseInt($(".input_1110_2-0").val());
		var input_1110_3_0	= parseInt($(".input_1110_3-0").val());
		...
		var input_1111_1_0	= parseInt($(".input_1111_1-0").val());
		var input_1111_2_0	= parseInt($(".input_1111_2-0").val());
		var input_1111_3_0	= parseInt($(".input_1111_3-0").val());
	...
	var input_1112_1_0	= input_1103_1_0 + input_1104_1_0 + input_1105_1_0 + input_1106_1_0 + input_1107_1_0 + input_1108_1_0 + input_1109_1_0 + input_1110_1_0 + input_1111_1_0;
	var input_1112_2_0	= input_1103_2_0 + input_1104_2_0 + input_1105_2_0 + input_1106_2_0 + input_1107_2_0 + input_1108_2_0 + input_1109_2_0 + input_1110_2_0 + input_1111_2_0;
	var input_1112_3_0	= input_1103_3_0 + input_1104_3_0 + input_1105_3_0 + input_1106_3_0 + input_1107_3_0 + input_1108_3_0 + input_1109_3_0 + input_1110_3_0 + input_1111_3_0;
	...
	var input_1112_1_1	= input_1103_1_2 + input_1104_1_2 + input_1105_1_2 + input_1106_1_2 + input_1107_1_2 + input_1108_1_2 + input_1109_1_2 + input_1110_1_2 + input_1111_1_2;
	var input_1112_2_1	= input_1103_2_2 + input_1104_2_2 + input_1105_2_2 + input_1106_2_2 + input_1107_2_2 + input_1108_2_2 + input_1109_2_2 + input_1110_2_2 + input_1111_2_2;
	var input_1112_3_1	= input_1103_3_2 + input_1104_3_2 + input_1105_3_2 + input_1106_3_2 + input_1107_3_2 + input_1108_3_2 + input_1109_3_2 + input_1110_3_2 + input_1111_3_2;
	...
	var input_1112_1_2	= input_1103_1_3 + input_1104_1_3 + input_1105_1_3 + input_1106_1_3 + input_1107_1_3 + input_1108_1_3 + input_1109_1_3 + input_1110_1_3 + input_1111_1_3;
	var input_1112_2_2	= input_1103_2_3 + input_1104_2_3 + input_1105_2_3 + input_1106_2_3 + input_1107_2_3 + input_1108_2_3 + input_1109_2_3 + input_1110_2_3 + input_1111_2_3;
	var input_1112_3_2	= input_1103_3_3 + input_1104_3_3 + input_1105_3_3 + input_1106_3_3 + input_1107_3_3 + input_1108_3_3 + input_1109_3_3 + input_1110_3_3 + input_1111_3_3;
	...
	// Bobot Rekonsilasi
	{
		...
		var perbedaan_1	=  Math.abs(input_1103_1_0) + Math.abs(input_1104_1_0) + Math.abs(input_1105_1_0) + Math.abs(input_1106_1_0) + Math.abs(input_1107_1_0) + Math.abs(input_1108_1_0) + Math.abs(input_1109_1_0) + Math.abs(input_1110_1_0) + Math.abs(input_1111_1_0);
		var perbedaan_2	=  Math.abs(input_1103_2_0) + Math.abs(input_1104_2_0) + Math.abs(input_1105_2_0) + Math.abs(input_1106_2_0) + Math.abs(input_1107_2_0) + Math.abs(input_1108_2_0) + Math.abs(input_1109_2_0) + Math.abs(input_1110_2_0) + Math.abs(input_1111_2_0);
		var perbedaan_3	=  Math.abs(input_1103_3_0) + Math.abs(input_1104_3_0) + Math.abs(input_1105_3_0) + Math.abs(input_1106_3_0) + Math.abs(input_1107_3_0) + Math.abs(input_1108_3_0) + Math.abs(input_1109_3_0) + Math.abs(input_1110_3_0) + Math.abs(input_1111_3_0);
		...
		var input_1105_0	= parseInt($(".input_1105_0").val());

		var input_1116_3 = input_1115_0 * input_1105_0;
		$(".input_1116_3").val(input_1116_3).trigger('change').attr("readonly", true).addClass("readonly").addClass("text-right").number( true, 0 );

		$("#textbox_pembanding_126").val(Math.round((input_1116_3 / 100000), 5) * 100000).addClass("text-right").attr("readonly", true).addClass("readonly").number( true, 0 ).trigger("change");

		var input_1116_3 	=	parseInt($(".input_1116_3").val());
		$(".input_689_Bangunan_1").val(Math.round((input_1116_3 / 100000), 5) * 100000).addClass("text-right").attr("readonly", true).addClass("readonly").number( true, 0 ).trigger("change");
	
		var input_1117_3	= parseInt($(".input_1117_3").val());

		if(input_1117_3 >= 20 && input_1117_3 <= 40){
			var input_1118_3 = input_1116_3 * ((100 / 100) - (input_1117_3/100));
			$(".input_1118_3").val(input_1118_3).trigger('change').attr("readonly", true).addClass("readonly").addClass("text-right").number( true, 0 );
		}else{
			alert("Nilai deprisiasi harus dari 20% sampai 40%");
			var input_1118_3 = input_1116_3 * ((100 / 100) - (input_1117_3/100));
			$(".input_1118_3").val(0).trigger('change').attr("readonly", true).addClass("readonly").addClass("text-right").number( true, 0 );
		}

		var input_1118_3 	=	parseInt($(".input_1118_3").val());
		$(".input_690_Bangunan_1").val(Math.round((input_1118_3 / 100000), 5) * 100000).attr("readonly", true).addClass("readonly").number( true, 0 ).trigger("change");
		
		$("#textbox_pembanding_127").val(Math.round((input_1118_3 / 100000), 5) * 100000).addClass("text-right").attr("readonly", true).addClass("readonly").number( true, 0 ).trigger("change");
...
{
	var input_1115_0 		= parseFloat($(".input_1115_0").val());
	var total_luas_tanah 	= 0;
...
{	
	...
	$(".input_1109_0").attr("readonly", true).addClass("readonly").val($("#textbox_bangunan_178").val()).trigger("change");
	...
	for(var i = 0; i <= jumlah_pembanding ; i++)
	{
		...
		$(".input_1109_" + i + "-1").addClass("text-right").attr("readonly", true).addClass("readonly").number( true, 0 );
		...
		$(".input_1109_" + i + "-2").addClass("text-right").attr("readonly", true).addClass("readonly").number( true, 0 );
		...
		$(".input_1109_" + i + "-3").addClass("text-right").attr("readonly", true).addClass("readonly").number( true, 0 );
		...
		$(".input_1111_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1110_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1109_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1108_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1107_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1106_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1105_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1104_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		$(".input_1103_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
		...
		$(".input_1112_" + i + "-0").addClass("text-center").css("background-color", "yellow").parent().css("background-color", "yellow");
...
function load_tab_bangunan(role)
{
	$.ajax({
		...
		success		: function (data) {
			...
			$("#textbox_bangunan_200").attr("placeholder", "Tidak Terinformasi");
	...
	$("." + role + " tr ").each(function(index) 
	{
		...
		$(this).find("td").each(function(index)
		{
			...
			else
			{
				...
				luas_tr = parseInt(luas_td) + luas_tr;
			}
...
$(document).on("change", "#textbox_bangunan_26, #textbox_bangunan_27, #textbox_bangunan_189, #textbox_bangunan_28, #textbox_bangunan_29, #textbox_bangunan_30, #textbox_bangunan_31, #textbox_bangunan_34, #textbox_bangunan_35", function(){
