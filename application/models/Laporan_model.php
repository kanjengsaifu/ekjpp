    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch,$con){
        ...
        */
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = "Ringkas"==$aRow['jenis_laporan'] ? '<a href="'.base_url().'printpdf/laporan_ringkas/'.base64_encode($aRow['id_pekerjaan']).'/'.base64_encode($aRow['id_lokasi']).'/'.base64_encode($aRow['id_kertas_kerja']).'/pdf/">Short Report</a>' : '<a href="'.base_url().'draft_laporan/download/'.$aRow['id_pekerjaan'].'">Narative</a>';
