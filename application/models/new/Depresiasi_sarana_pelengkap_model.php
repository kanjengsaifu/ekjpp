...
class Depresiasi_sarana_pelengkap_model extends CI_Model
{
    var $table      = 'mst_depresiasi_sarana_pelengkap';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch,$con){
        ...
        */
        ...
        $this->db->join($this->table_jenis_objek.' B', 'B.id=A.id_jenis_objek', 'left');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['jenis_objek'];
            $row[] = $aRow['sarana_pelengkap'];
            $row[] = $aRow['nilai'];
            $row[] = '<a href="#" onclick="go_delete_data('.$aRow['id'].')"><i class="fa fa-trash"> Hapus</a>';
