...
class Upload_surat_tugas_final_model extends CI_Model
{
    var $table      = 'mst_pekerjaan';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch,$con){
        ...
        */
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['nama'];
            $row[] = !$aRow['surat_tugas_final'] ? '-' : '<a href="'.base_url().'asset/file/'.$aRow['surat_tugas_final'].'">Download</a>';
