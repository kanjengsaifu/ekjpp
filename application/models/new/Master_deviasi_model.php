...
class Master_deviasi_model extends CI_Model
{
    var $table      = 'mst_persen_deviasi';
    var $table_jenis_objek = 'mst_jenis_objek';
    var $pk_name    = 'id_persen_deviasi';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch,$con){
        ...
        */
        ...
        $this->db->where($where);
        $this->db->select('A.id_persen_deviasi, B.nama, A.id_jenis_objek, A.nilai');
