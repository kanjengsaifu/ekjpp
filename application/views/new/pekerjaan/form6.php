                    ...
                    <div role="tabpanel" id="entry" <?php echo (isset($_GET["role"]) && $_GET["role"]=="entry") ? "class=\"tab-pane active\"" : "class=\"tab-pane\" " ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Nama Apartment</label>
                                        <input type="text" id="textbox_entry_9100" name="update[entry_9100]" class="form-control table_input input_9100_ " value="<?php echo $txn_kertas_kerja['nama_apartment'] ?>" data-id-field="9100" data-keterangan="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Nama Tower</label>
                                        <input type="text" id="textbox_entry_9101" name="update[entry_9101]" class="form-control table_input input_9101_ " value="<?php echo $txn_kertas_kerja['nama_tower'] ?>" data-id-field="9101" data-keterangan="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel panel-default">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <table class="table table_border" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="textbox_tanah_1" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_kertas_kerja["status_objek"] ?>" data-id-field="2030" data-keterangan="">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>Obyek dihuni oleh</span></td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_2" name="update[tanah_2]" class="form-control table_input input_103_ " value="<?php echo $txn_kertas_kerja["obyek_ditempati_oleh"] ?>" data-id-field="2031" data-keterangan="">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>Penggunaan obyek</span></td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_3" name="update[tanah_3]" class="form-control table_input input_104_ " value="<?php echo $txn_kertas_kerja["penggunaan_obyek"] ?>" data-id-field="2032" data-keterangan="">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="col-md-6">
                                                    <table class="table table_border" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td><span>Lokasi Apartemen</span></td>
                                                            <td>
                                                                <select class="form-control table_input input_113_" id="textbox_tanah_12" name="update[tanah_12]" data-id-field="113" data-keterangan="">
                                                                    ...
                                                                    <option value="<?php echo $value->lokasi_tanah_objek ?>" <?php echo ($txn_tanah["lokasi_apartment"] == $value->lokasi_tanah_objek) ? "selected" : "" ?>><?php echo $value->lokasi_tanah_objek ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-control table_input input_114_" id="textbox_tanah_13" name="update[tanah_13]" data-id-field="114" data-keterangan="">
                                                                    ...
                                                                    <option value="<?php echo $value->harga_tanah_objek ?>" <?php echo ($value->harga_tanah_objek==$txn_tanah["harga_apartment"]) ? "selected":"" ?>><?php echo $value->harga_tanah_objek ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <table class="table table_border">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_tanah["kepemilkan"] ?>" data-id-field="2031" data-keterangan=""></td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>Penyewaan</span></td>
                                                            <td><input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_tanah["penyewaan"] ?>" data-id-field="2032" data-keterangan=""></td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>Instansi</span></td>
                                                            <td><input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_tanah["instansi"] ?>" data-id-field="2033" data-keterangan=""></td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>Kosong</span></td>
                                                            <td><input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_tanah["kosong"] ?>" data-id-field="2034" data-keterangan=""></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table" cellpadding="0" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <input type="text" id="textbox_tanah_50" name="update[tanah_50]" class="form-control table_input input_151_ " value="<?php echo $txn_tanah["nomor_imb"] ?>" data-id-field="151" data-keterangan="">
                                                            </span>
                                                        </td>
                                                        <td>Luas Bangunan Berdasarkan IMB</td>
                                                        <td>
                                                            <span>
                                                                <input type="text" id="textbox_tanah_52" name="update[tanah_52]" class="form-control table_input input_153_ " value="<?php echo $txn_tanah["luas_imb"] ?>" data-id-field="153" data-keterangan="">
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr style="display: none">
                                                        <td colspan="4">
                                                            <input type="hidden" class="table_input" value="1" data-id-field="152">
                                                        </td>
                                                    </tr>
                                                </thead>
                                            </table>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="bangunan_bangunan_<?php echo $role ?>">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body" style="margin-top:2.5%;">
                                            <div class="col-md-8">
                                                <table class="table table_bangunan <?php echo $role ?>" cellpadding="0" cellspacing="0">
                                                <?php 
                                                    $x = 1;
                                                    $y = 1;
                                                    ...
                                                    <tbody id="tbody_data_legalitas_1">
                                                        <tr>
                                                            ...
                                                            <td>Ruang Tamu</td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__1__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__1__1 <?php echo $role ?>">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__2__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__2__1 <?php echo $role ?>">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Ruang Makan</td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__3__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__3__1 <?php echo $role ?>"></td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>Kamar Tidur</td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__4__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__4__1 <?php echo $role ?>">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Ruang Gudang</td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__5__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__5__1 <?php echo $role ?>"></td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>Ruang Dapur</td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__6__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__6__1 <?php echo $role ?>">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Kamar Mandi</td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__7__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__7__1 <?php echo $role ?>">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Lain-lain</td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $role ?>__8__1 <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $role ?>__8__1 <?php echo $role ?>">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="" data-id-field="102" data-keterangan="">
                                                            </td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <td align="center" colspan="2"><span>TOTAL LUAS RUANG APARTEMEN</span></td>
                                                            <td>
                                                                <input type="text" id="textbox_bangunan_5" name="update[tanah_1]" class="form-control table_input input_639_<?php echo $role ?> <?php echo $role ?>" value="0" data-id-field="102" data-keterangan="<?php echo $role ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" colspan="2"><span>TOTAL LUAS APARTEMEN</span></td>
                                                            <td>
                                                                <input type="text" id="textbox_bangunan_130" name="update[tanah_1]" class="form-control table_input input_640_<?php echo $role ?> <?php echo $role ?>" value="0" data-id-field="640" data-keterangan="<?php echo $role ?>">
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            ...
                                            <div class="col-md-2">
                                                <table id="table table_data_legalitas_1" class="table table_border_2" cellpadding="0" cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                            <th>Teras (m2)</th>
                                                        </tr>
                                                    ...
                                                    <tbody id="tbody_data_legalitas_1">
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <td>
                                                                <input type="text" id="textbox_bangunan_129" name="update[tanah_1]" class="form-control table_input input_637_<?php echo $koordinat ?> <?php echo $role ?> <?php echo $koordinat ?> <?php echo $role ?>" value="<?php echo $luas_ruangan_z ?>" data-id-field="637" data-keterangan="<?php echo $koordinat ?> <?php echo $role ?>">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table_border" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['nama_tower'] ?>" data-id-field="2000" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%">
                                                        <span>Jumlah Kamar Tidur</span>
                                                    </td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['jumlah_kamar_tidur'] ?>" data-id-field="2004" data-keterangan="<?php echo $role ?>"></td>
                                                    <td width="15%"><span>Dapur Bersih</span>
                                                    </td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['dapur_bersih'] ?>" data-id-field="2008" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="15%"><span>Letak Lantai Obyek</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['letak_lantai_objek'] ?>" data-id-field="2001" data-keterangan="<?php echo $role ?>"></td>
                                                    <td width="15%"><span>Jumlah Kamar Mandi</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['jumlah_kamar_mandi'] ?>" data-id-field="2005" data-keterangan="<?php echo $role ?>"></td>
                                                    <td width="15%"><span>Laundry Room</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['nama_tower'] ?>" data-id-field="2009" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="15%"><span>Posisi Ruang Apartemen</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['posisi_ruang_apartment'] ?>" data-id-field="2002" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%"><span>Furnished</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['furnished'] ?>" data-id-field="2006" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%"><span>Kamar Pembantu</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['kamar_pembantu'] ?>" data-id-field="2010" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="15%"><span>View (Menghadap Ke)</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['view_menghadap_ke'] ?>" data-id-field="2003" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%"><span>Dinding Ruangan</span>
                                                    </td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['dinding_ruangan'] ?>" data-id-field="2007" data-keterangan="<?php echo $role ?>"></td>
                                                    <td width="15%"><span>Teras / Balkon</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['teras_balkon'] ?>" data-id-field="2011" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table_border" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['saluran_listrik'] ?>" data-id-field="2012" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%"><span>Pemanas Air</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['pemanas_air'] ?>" data-id-field="2016" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="15%"><span>Pendingin Ruangan (AC)</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['ac'] ?>" data-id-field="2013" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%"><span>Jenis Kamar Mandi</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['jenis_kamar_mandi'] ?>" data-id-field="2017" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="15%"><span>Sambungan Telepon</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['sambungan_telepon'] ?>" data-id-field="2014" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%"><span>Sanitair</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['sanitair'] ?>" data-id-field="2018" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="15%"><span>Air Bersih</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['air_bersih'] ?>" data-id-field="2015" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                    <td width="15%"><span>Pembuangan Sampah</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan['pembuangan_sampah'] ?>" data-id-field="2019" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="panel-body" style="border: 1px solid #e1e1e1;">
                                        ...
                                        <div class="col-md-6">
                                            <p style="font-weight: bold;">FAKTOR PENENTU NILAI PROPERTI</p>
                                            <table class="table table_border" cellpadding="0" cellspacing="0">
                                                <colgroup>
                                                    <col>
                                                    <col>
                                                ...
                                                <tr>
                                                    <td><span>Perawatan</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2067_ " value="<?php echo $txn_bangunan["informasi_njop_properti"] ?>" data-id-field="2067" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><span>Kondisi</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2068_ " value="<?php echo $txn_bangunan["bumi_bersama"] ?>" data-id-field="2068" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><span>Konstruksi</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2069_ " value="<?php echo $txn_bangunan["bangunan_bersama"] ?>" data-id-field="2069" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><span>Lantai</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2070_ " value="<?php echo $txn_bangunan["bangunan_bersama"] ?>" data-id-field="2070" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><span>Umur Bangunan</span></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2071_ " value="<?php echo $txn_bangunan["bangunan_bersama"] ?>" data-id-field="2071" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Total</strong></td>
                                                    <td>
                                                        <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2072_ " value="0" data-id-field="2072" data-keterangan="<?php echo $role ?>" readonly>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table class="table table_border" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td><span>Informasi NJOP Properti</span></td>
                                                    <td><input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan["informasi_njop_properti"] ?>" data-id-field="2020" data-keterangan="<?php echo $role ?>"></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table class="table table_border" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="nilai_pasar_bangunan" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan["nilai_pasar"] ?>" data-id-field="2023" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" id="nilai_likuidasi_bangunan" name="update[tanah_1]" class="form-control table_input input_102_ " value="<?php echo $txn_bangunan["nilai_likuidasi"] ?>" data-id-field="2024" data-keterangan="<?php echo $role ?>">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <table class="table-movefield table_border_3" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_969_0 0" value="<?php echo $txn_data_banding_0["nama_apartment"] ?>" data-id-field="969" data-keterangan="0"></td>
                                            <td><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_969_1 1" value="<?php echo $txn_data_banding_1["nama_apartment"] ?>" data-id-field="969" data-keterangan="1"></td>
                                            <td><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_969_2 2" value="<?php echo $txn_data_banding_2["nama_apartment"] ?>" data-id-field="969" data-keterangan="2"></td>
                                            <td><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_969_3 3" value="<?php echo $txn_data_banding_3["nama_apartment"] ?>" data-id-field="969" data-keterangan="3"></td>
                                        </tr>
                                        <tr>
                                            <td><span>Nama Tower </span></td>
                                            <td><input type="text" id="textbox_pembanding_101" name="update[pembanding_101]" class="form-control table_input input_979_0 0" value="<?php echo $txn_data_banding_0["nama_tower"] ?>" data-id-field="979" data-keterangan="0"></td>
                                            <td><input type="text" id="textbox_pembanding_101" name="update[pembanding_101]" class="form-control table_input input_979_1 1" value="<?php echo $txn_data_banding_1["nama_tower"] ?>" data-id-field="979" data-keterangan="1"></td>
                                            <td><input type="text" id="textbox_pembanding_101" name="update[pembanding_101]" class="form-control table_input input_979_2 2" value="<?php echo $txn_data_banding_2["nama_tower"] ?>" data-id-field="979" data-keterangan="2"></td>
                                            <td><input type="text" id="textbox_pembanding_101" name="update[pembanding_101]" class="form-control table_input input_979_3 3" value="<?php echo $txn_data_banding_3["nama_tower"] ?>" data-id-field="979" data-keterangan="3"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><span>Luas Ruangan Apartemen </span></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2063_0 0" value="<?php echo $txn_data_banding_0['view_menghadap_ke'] ?>" data-id-field="2063" data-keterangan="0">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2063_1 1" value="<?php echo $txn_data_banding_1['view_menghadap_ke'] ?>" data-id-field="2063" data-keterangan="1"></td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2063_2 2" value="<?php echo $txn_data_banding_2['view_menghadap_ke'] ?>" data-id-field="2063" data-keterangan="2">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2063_3 3" value="<?php echo $txn_data_banding_3['view_menghadap_ke'] ?>" data-id-field="2063" data-keterangan="3">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2064_0 0" value="<?php echo $txn_data_banding_0['posisi_ruang_apartment'] ?>" data-id-field="2064" data-keterangan="0">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2064_1 1" value="<?php echo $txn_data_banding_1['posisi_ruang_apartment'] ?>" data-id-field="2064" data-keterangan="1">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2064_2 2" value="<?php echo $txn_data_banding_2['posisi_ruang_apartment'] ?>" data-id-field="2064" data-keterangan="2">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2064_3 3" value="<?php echo $txn_data_banding_3['posisi_ruang_apartment'] ?>" data-id-field="2064" data-keterangan="3">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span>Furnished</span></td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2065_0 0" value="<?php echo $txn_data_banding_0['furnished'] ?>" data-id-field="2065" data-keterangan="0">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2065_1 1" value="<?php echo $txn_data_banding_1['furnished'] ?>" data-id-field="2065" data-keterangan="1">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2065_2 2" value="<?php echo $txn_data_banding_2['furnished'] ?>" data-id-field="2065" data-keterangan="2">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2065_3 3" value="<?php echo $txn_data_banding_3['furnished'] ?>" data-id-field="2065" data-keterangan="3">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span>Jumlah Kamar Tidur</span></td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2066_0 0" value="<?php echo $txn_data_banding_0['jumlah_kamar_tidur'] ?>" data-id-field="2066" data-keterangan="0">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2066_1 1" value="<?php echo $txn_data_banding_1['jumlah_kamar_tidur'] ?>" data-id-field="2066" data-keterangan="1">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2066_2 2" value="<?php echo $txn_data_banding_2['jumlah_kamar_tidur'] ?>" data-id-field="2066" data-keterangan="2">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_tanah_920" name="update[tanah_1]" class="form-control table_input input_2066_3 3" value="<?php echo $txn_data_banding_3['jumlah_kamar_tidur'] ?>" data-id-field="2066" data-keterangan="3">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center">
                                                <span>Indikasi Rasio M2 Space Ruang Apartemen</span>
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_pembanding_30" name="update[pembanding_30]" class="form-control table_input input_1102_1 1" value="<?php echo $txn_data_banding_1['indikasi_rasio_ruang_apartment'] ?>" data-id-field="1102" data-keterangan="1">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_pembanding_30" name="update[pembanding_30]" class="form-control table_input input_1102_2 2" value="<?php echo $txn_data_banding_2['indikasi_rasio_ruang_apartment'] ?>" data-id-field="1102" data-keterangan="2">
                                            </td>
                                            <td>
                                                <input type="text" id="textbox_pembanding_30" name="update[pembanding_30]" class="form-control table_input input_1102_3 3" value="<?php echo $txn_data_banding_3['indikasi_rasio_ruang_apartment'] ?>" data-id-field="1102" data-keterangan="3">
                                            </td>
                                        </tr>
                                        <!--Penyesuaian-->
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 213px;">
                                                <table style="width: 100%;">
                                                    <tbody>
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 36%;">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_0 0" data-id-field="2086" data-keterangan="0">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_1 1" data-id-field="2086" data-keterangan="1">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_2 2" data-id-field="2086" data-keterangan="2">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_3 3" data-id-field="2086" data-keterangan="3">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 213px;">
                                                <table style="width: 100%;">
                                                    <tbody>
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 36%;">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_0 0" data-id-field="2087" data-keterangan="0">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_1 1" data-id-field="2087" data-keterangan="1">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_2 2" data-id-field="2087" data-keterangan="2">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_3 3" data-id-field="2087" data-keterangan="3">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 213px;">
                                                <table style="width: 100%;">
                                                    <tbody>
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 36%;">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_0 0" data-id-field="2088" data-keterangan="0">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                                    <option value="<?php echo $rank; ?>" <?php echo $rank==$txn_data_banding_0["jumlah_kamar_tidur_op"] ? 'selected' : NULL ?>><?php echo $rank ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_1 1" data-id-field="2088" data-keterangan="1">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                                    <option value="<?php echo $rank; ?>" <?php echo $rank==$txn_data_banding_1["jumlah_kamar_tidur_op"] ? 'selected' : NULL ?>><?php echo $rank ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_2 2" data-id-field="2088" data-keterangan="2">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                                    <option value="<?php echo $rank; ?>" <?php echo $rank==$txn_data_banding_2["jumlah_kamar_tidur_op"] ? 'selected' : NULL ?>><?php echo $rank ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_3 3" data-id-field="2088" data-keterangan="3">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                                    <option value="<?php echo $rank; ?>" <?php echo $rank==$txn_data_banding_3["jumlah_kamar_tidur_op"] ? 'selected' : NULL ?>><?php echo $rank ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 213px;">
                                                <table style="width: 100%;">
                                                    <tbody>
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 36%;">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_0 0" data-id-field="2089" data-keterangan="0">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_1 1" data-id-field="2089" data-keterangan="1">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_2 2" data-id-field="2089" data-keterangan="2">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                                        ...
                                                        <td style="padding: 0px 0px 0px 0px; border-bottom: 0px; width: 21%; border-right: 0px; border-left: 1px solid #ddd">
                                                            <select style="width: 100%;" id="textbox_pembanding_105" name="update[pembanding_105]" class="form-control table_input input_2083_3 3" data-id-field="2089" data-keterangan="3">
                                                                <option value=""></option>
                                                                <?php
                                                                for ( $rank=1; $rank<=4; $rank++ ) {
                                                                    ?>
                                        ...
                                        <tr>
                                            <td style="background-color: #eee;">
                                                <!-- <span>Nilai Pasar Bangunan Kios (Fisik)</span> -->
...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/apps/form_6.js?v=<?=time()?>"></script>
