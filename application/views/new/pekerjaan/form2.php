                                    ...
                                    <div class="panel-body" style="border: 1px solid #e1e1e1;">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <table class="table table_border" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td><span>NILAI PASAR</span></td>
                                                    <td><input type="text" id="textbox_bangunan_55" name="update[bangunan_55]" class="form-control table_input input_689_<?php echo $role ?> <?php echo $role ?>" value="<?php echo $txn_bangunan["nilai_pasar_fisik"] ?>" data-id-field="689" data-keterangan="<?php echo $role ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td><span>INDIKASI NILAI LIKUIDASI</span></td>
                                                    <td><input type="text" id="textbox_bangunan_56" name="update[bangunan_56]" class="form-control table_input input_690_<?php echo $role ?> <?php echo $role ?>" value="<?php echo $txn_bangunan["indikasi_nilai_likuidasi_fisik"] ?>" data-id-field="690" data-keterangan="<?php echo $role ?>"></td>
                                                </tr>
                                            </table>
                                ...
                                <table class="table-movefield table_border_3" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="textbox_pembanding_15" name="update[pembanding_15]" class="form-control table_input input_261_0 0" value="<?php echo $txn_data_banding_0["luas_bangunan"] ?>" data-id-field="261" data-keterangan="0"></td>
                                            <td><input type="text" id="textbox_pembanding_15" name="update[pembanding_15]" class="form-control table_input input_261_1 1" value="<?php echo $txn_data_banding_1["luas_bangunan"] ?>" data-id-field="261" data-keterangan="1"></td>
                                            <td><input type="text" id="textbox_pembanding_15" name="update[pembanding_15]" class="form-control table_input input_261_2 2" value="<?php echo $txn_data_banding_2["luas_bangunan"] ?>" data-id-field="261" data-keterangan="2"></td>
                                            <td><input type="text" id="textbox_pembanding_15" name="update[pembanding_15]" class="form-control table_input input_261_3 3" value="<?php echo $txn_data_banding_3["luas_bangunan"] ?>" data-id-field="261" data-keterangan="3"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><span><strong>Jenis Bangunan</strong></span></td>
                                            <td><input type="text" id="textbox_pembanding_101" name="update[pembanding_101]" class="form-control table_input input_2079_0 0" value="<?php echo $txn_bangunan["tipe_bangunan_btb"] ?>" data-id-field="2079" data-keterangan="0" readonly ></td>
                                            <td>
                                                <select class="form-control table_input input_2079_1 1" id="textbox_pembanding_101" name="update[pembanding_101]" data-id-field="2079" data-keterangan="1">
                                                    <option value="">Select</option>
                                                    <?php 
                                                    foreach ($tipe_bangunan_btb as $key => $value) { ?>
                                                    <option value="<?php echo $value->tipe_bangunan_btb ?>" <?php echo ($value->tipe_bangunan_btb===$txn_data_banding_1["tipe_bangunan"]) ? "selected" : "" ?> data-kode_tipe_bangunan="<?php echo $value->kode_tipe_bangunan ?>"><?php echo $value->tipe_bangunan_btb ?></option>
                                                    <?php 
                                                    } 
                                                    ?>
                                                </select>
                                            ...
                                            <td>
                                                <select class="form-control table_input input_2079_2 2" id="textbox_pembanding_101" name="update[pembanding_101]" data-id-field="2079" data-keterangan="2">
                                                    <option value="">Select</option>
                                                    <?php 
                                                    foreach ($tipe_bangunan_btb as $key => $value) { ?>
                                                    <option value="<?php echo $value->tipe_bangunan_btb ?>" <?php echo ($value->tipe_bangunan_btb===$txn_data_banding_2["tipe_bangunan"]) ? "selected" : "" ?> data-kode_tipe_bangunan="<?php echo $value->kode_tipe_bangunan ?>"><?php echo $value->tipe_bangunan_btb ?></option>
                                                    <?php 
                                                    } 
                                                    ?>
                                                </select>
                                            ...
                                            <td>
                                                <select class="form-control table_input input_2079_3 3" id="textbox_pembanding_101" name="update[pembanding_101]" data-id-field="2079" data-keterangan="3">
                                                    <option value="">Select</option>
                                                    <?php 
                                                    foreach ($tipe_bangunan_btb as $key => $value) { ?>
                                                    <option value="<?php echo $value->tipe_bangunan_btb ?>" <?php echo ($value->tipe_bangunan_btb===$txn_data_banding_3["tipe_bangunan"]) ? "selected" : "" ?> data-kode_tipe_bangunan="<?php echo $value->kode_tipe_bangunan ?>"><?php echo $value->tipe_bangunan_btb ?></option>
                                                    <?php 
                                                    } 
                                                    ?>
                                                </select>
                                        ...
                                        <tr>
                                            <td style="background-color: #ADFF2F;"><span>BRB Standar MAPPI</span></td>
                                            <td style="background-color: #ADFF2F;"><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_2080_0 0" value="<?php echo $txn_data_banding_0["brb_standar_mappi"] ?>" data-id-field="2080" data-keterangan="0" readonly ></td>
                                            <td style="background-color: #ADFF2F;"><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_2080_1 1" value="<?php echo $txn_data_banding_1["brb_standar_mappi"] ?>" data-id-field="2080" data-keterangan="1" readonly ></td>
                                            <td style="background-color: #ADFF2F;"><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_2080_2 2" value="<?php echo $txn_data_banding_2["brb_standar_mappi"] ?>" data-id-field="2080" data-keterangan="2" readonly ></td>
                                            <td style="background-color: #ADFF2F;"><input type="text" id="textbox_pembanding_102" name="update[pembanding_102]" class="form-control table_input input_2080_3 3" value="<?php echo $txn_data_banding_3["brb_standar_mappi"] ?>" data-id-field="2080" data-keterangan="3" readonly ></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right" colspan="2" style="background-color: white;"><span>Indikasi Nilai Tanah ( / m<sup>2</sup> )</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 0px 0; width: 250px; font-weight: bold;">
                                                <table style="width:100%">
                                                    <thead>
                                                        <th style="text-align: center; padding: 10px 0px 10px 0px; border-bottom: 0px; width: 36%;">RANGKING - OP</th>
                                                        <th style="text-align: center; padding: 10px 0px 10px 0px; border-bottom: 0px; width: 21%">DT-1</th>
                                                        <th style="text-align: center; padding: 10px 0px 10px 0px; border-bottom: 0px; width: 21%;">DT-2</th>
                                                        <th style="text-align: center; padding: 10px 0px 10px 0px; border-bottom: 0px; width: 21%; border-right: 0px;">DT-3</th>
                                                    </thead>
                                                </table>
                                            </th>
...
<script type="text/javascript" src="<?php echo base_url() ?>resources/js/apps/form_2.js?v=<?php echo time() ?>"></script>
