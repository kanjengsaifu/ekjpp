			...
			<div class="tab-content" style="padding: 20px; border: 1px solid #eee;">
						...
						<table class="table_border" cellpadding="0" cellspacing="0" >
							<tbody>
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td><span>Nomor Unit Kios</span></td>
									...
									<div class="panel panel-default">
											...
											<div class="col-lg-6" style="padding: 0px;">
												<table class="table_border">
													<tr>
														...
														<td width="25px"><?=$input["tanah_39"];?></td>
													</tr>
													<tr>
										...
										<!-- <div class="panel-body" style="border: 1px solid #e1e1e1; border-top: 0px;">
											...
											<div class="col-lg-6" style="padding: 0px;">
												<table class='table_border' cellpadding='0' cellspacing='0'>
													<tr>
														<td width='25%'><span>Lokasi Bidang Tanah</span></td>
														<td colspan='3'><?=$input["tanah_90"];?></td>
													</tr>
													<tr>
														<td width='25%'><span>Topografi / Kontur</span></td>
														<td colspan='3'><?=$input["tanah_45"];?></td>
													</tr>
													<tr>
														<td width='25%'><span>Bentuk Bidang Tanah</span></td>
														<td colspan='3'><?=$input["tanah_46"];?></td>
													</tr>
											
													<tr>
														<td width='25%'><span>Ukuran Tanah (L x P)</span></td>
													...
													<tr>
														<td width='25%'><span>Menghadap Ke-arah</span></td>
														<td colspan='3'><?=$input["tanah_92"];?></td>
													</tr>
													<tr>
														<td width='25%'><span>Tata Lingkungan</span></td>
														<td colspan='3'><?=$input["tanah_47"];?></td>
													</tr>
													<tr>
														<td width='25%'><span>Resiko Banjir</span></td>
														<td colspan='3'><?=$input["tanah_48"];?></td>
													</tr>
													</table>
											...
											<!-- <div class="col-lg-6" style="padding: 0px;">
												<table class="table_border">
													...
													<tr>
														<td><span>Peruntukan Kawasan/Zoning</span></td>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body" style="border: 1px solid #e1e1e1; border-top: 0px;">
											...
											<br>
												<table class="table_border">
													<tr>
														<td><span>Nomor IMB (Bersama)</span></td>
														<td><?=$input["tanah_50"];?></td>
													</tr>
													<tr>
														<td><span>Tanggal di Keluarkan IMB (Bersama)</span></td>
														<td><?=$input["tanah_51"];?></td>
													</tr>
											...
											<br>
												<table class="table_border">
													<tr>
														<td><span>Luas Bangunan Berdasarkan IMB</span></td>
														<td><?=$input["tanah_52"];?></td>
													</tr>
													<tr>
														<td colspan="2"><span>(Luas Keseluruhan Blok)</span></td>
											...
											<table width="100%" cellpadding="0" cellspacing="0">
												<thead>
													<tr>
														...
														<td><span style="border: 1px solid #e1e1e1; border-right:0px;"><?=$input["tanah_50"];?></span></td>
														<td>Luas Bangunan Berdasarkan IMB</td>
														<td><span style="border: 1px solid #e1e1e1; border-right:0px;"><?=$input["tanah_52"];?></span></td>
													</tr>
													<tr>
														<td>Tanggal di Keluarkan IMB (Bersama)</td>
														<td><span style="border: 1px solid #e1e1e1; border-right:0px;"><?=$input["tanah_51"];?></span></td>
										...
										<div class="panel-body" style="border: 1px solid #e1e1e1; border-top: 0px;">
											<table id="table_data_legalitas_1" class="table_border_2" width="100%" cellpadding="0" cellspacing="0">
												...
												<tfoot>
													<tr>
														<td align="center" colspan="8"><span>TOTAL LUAS UNIT KIOS SESUAI SERTIFIKAT</span></td>
				...
				<div role="tabpanel" class="tab-pane" style="padding: 0px;" id="dbanding">
					...
					<table class="table_border_2" width="100%" cellpadding="0" cellspacing="0">
						<tbody>
							<tr>
								<td style="background-color: #eee;"><span>PEMBULATAN NILAI PASAR PROPERTI/KIOS</span></td>
								<td><?=$input["pembanding_47"];?></td>
							</tr>
							<tr>
								<td style="background-color: #eee;"><span>PEMBULATAN NILAI LIKUIDASI</span></td>
...
<script src="<?=base_url()?>asset/js/form_3.js?ver=1"></script>
<style>
	.input_879_,
	.input_880_,
	.input_881_,
