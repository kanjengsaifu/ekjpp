...
<section class="content">
	<form name="form-klien" id="form-klien" method="post">
		...
		<input type="hidden" id="id_klien" name="id_klien" class="form-control input-sm number-id_klien" value="<?php echo $id_klien ?>" placeholder="id_klien" required="">
	-->
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<div class="col-md-12 col-xs-12 panel-2" style="padding: 0px; margin-top: 0px; margin-bottom: 20px;">
					...
					<div style="padding: 20px;  border: 1px solid #ccc;">
						<div class="table_div" style="margin-bottom: 10px;">
							...
							<div class="table-responsive">
								<table class="table table_custom1 table_tugas" cellpadding='0' cellspacing='0' border='0' style="width: 100%" id="datatable_penugasan">
									<thead>
										<tr>
											<th>No</th>
											<th>Kode</th>
				...
				<?php
					...
					{
				?>
				<a href='<?=base_url("printpdf/ringkasan/".base64_encode($pekerjaan->id))?>' class='btn btn-primary btn-sm btn-download-ringkasan' style="margin-bottom: 10px;">DOWNLOAD RINGKASAN PENILAIAN</a><br />
				<?php
					}
				?>
				<!--Draf Laporan-->
