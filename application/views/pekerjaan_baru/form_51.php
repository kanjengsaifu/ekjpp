			...
			<div class="tab-content" style="padding: 20px; border: 1px solid #eee;">
										...
										<div class="panel-body" style="border: 1px solid #e1e1e1; border-top: 0px;">
											<table id="table_data_legalitas_1" class="table_border_2" width="100%" cellpadding="0" cellspacing="0">
												...
												<tfoot>
													...
													<tr>
														<td align="right" style="background-color: white;" colspan="8"><span>Total luas tanah yang terpotong (rencana pembangunan / pelebaran jalan)</span></td>
														<td><?=$input["tanah_62"];?></td><td>m<sup>2</sup></td>
													</tr>
												
													<tr>
														<td align="right" style="background-color: white;" colspan="8"><span>Luas tanah yang dapat dinilai</span></td>
														<td><?=$input["tanah_97"];?></td><td>m<sup>2</sup></td>
													</tr>
												</tfoot>
											</table><br> 
											...
											<div class="col-lg-6" style="padding: 0px;">
												<table class="table_border" cellpadding="0" cellspacing="0">
													<tbody>
														...
														<tr>
															<td><span>Bangunan ( / m<sup>2</sup> )</span></td>
				...
				<div role="tabpanel" class="tab-pane" style="padding: 0px;" id="dbanding">
					...
					<table class="table_border_2" width="100%" cellpadding="0" cellspacing="0">
						<tbody>
							<tr>
								<td style="background-color: #eee;"><span>PEMBULATAN NILAI PASAR PROPERTI/RUKAN</span></td>
...
<script src="<?=base_url()?>asset/js/form_5.js?ver=1"></script>
<style>
	.input_879_,
	.input_880_,
	.input_881_,
