			...
			<div class="box-body">
				<form name="form-dokumen" id="form-dokumen" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Berupa</label><span class="required">*</span><br />
						<?=$input["berupa"]?>
					</div>
					<div class="form-group">
						<label>Bank</label><span class="required">*</span>
						<?=$input["bank"]?>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Sebesar</label><span class="required">*</span>
						<?=$input["sebesar"]?>
					</div>
					<div class="form-group">
						<label>Terbilang</label><span class="required">*</span>
						<?=$input["terbilang"]?>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Dikirim Oleh</label><span class="required">*</span>
						<?=$input["dikirim"]?>
					</div>
					<div class="form-group">
						<label>Diterima Oleh</label><span class="required">*</span>
						<?=$input["diterima"]?>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="hidden" id="dokumen_final_file" name="input[dokumen_final]">
