...
<div class="content">
	<div class="content-inner inner-page">
		...
		<form name="form-kertas-kerja" id="form-kertas-kerja" method="post">
			...
			<!--
			<pre><?php  var_dump($list_bangunan); ?></pre>
			-->
			...
			<div class="tab-content" style="padding: 20px; border: 1px solid #eee;">
						...
						<div class="col-sm-6">
							...
							<div class="form-group row">
								<div class="col-md-12">
									<label>Klien</label>
									<div class="row">
										<div class="col-md-6"><?=$input["entry_6"]?></div>
										<div class="col-md-6"><?=$input["entry_7"]?></div>
									</div>
								</div>
							</div>
				...
				<div role="tabpanel" class="tab-pane" style="padding: 0px;" id="dbanding">
					...
					<div id="table_pembanding" class="table-responsive"></div>
