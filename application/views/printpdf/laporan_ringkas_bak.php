<style type="text/css">
	html, body { font-family: Arial Narrow }
	.page
	{
		width: 710px;
		font-size: 10pt;
	...
	.table thead th, .table tfoot td
	{
		...
		background-color: #010961; color: #ffffff;
		padding: 2px 10px;
	}
...
<body>
	...
	<div class="panel">
		<div class="panel-content" style="padding-bottom: 5px; padding-top: 5px;">
			<table class="default_table" border="0" style="max-width: 750px;width: 750px;">
				<tr>
					<td style="width: 160px">Tanggal Laporan</td>
					<td width="20" align="center">:</td>
					<td style="width: 135px; border-right: 1px dotted #ccc;"><?php echo format_datetime($kertas_kerja->tanggal_laporan) ?></td>
					<td style="width: 100px">No. Laporan</td>
					<td width="20" align="center">:</td>
	...
	<div class="panel">
		<div class="panel-content">
			<table class="default_table" style="max-width: 750px;width: 750px;">
				<tr>
					<td style="width: 160px">Perusahaan Jasa Penilai</td>
					<td width="20" align="center">:</td>
					<td>
				...
				<tr>
					<td style="width: 160px">Maksud & Tujuan Penilaian</td>
					<td width="20" align="center">:</td>
	...
	<table class="table"  cellpadding="2" cellspacing="0" style="margin-top: 5px;">
		<thead>
		<tr>
			<th>
				OBYEK PENILAIAN
	...
	<br />
	<table class="table" cellpadding="2" cellspacing="0" style="width: 762px">
		<thead>
		<tr>
	...
	<table style="width: 760px; margin-top: 8px">
		<tr>
			<td style="padding: 0px 0px 0px 0px; width: 65%;">
						...
						<table style="width: 100%; margin-top: 8px;" >
							<tr>
								...
								foreach ($lokasi_tanah_obyek as $lto) {
									...
									?>
									<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo $selected; ?></td>
				...
				<div class="panel" style="width: 100%;">
					...
					<div class="panel-content">
						<table style="width: 100%;" >
							<tr>
								<td></td>
								<td style="font-size: 8pt">Baik</td>
								<td></td>
								<td style="font-size: 8pt">Cukup</td>
								<td></td>
								<td style="font-size: 8pt">Kurang</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_mencapai_lokasi) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_mencapai_lokasi) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_mencapai_lokasi) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_belanja) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_belanja) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_belanja) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_sarana_pendidikan) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_sarana_pendidikan) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_sarana_pendidikan) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_angkutan_umum) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_angkutan_umum) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_angkutan_umum) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_rekreasi) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_rekreasi) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->kemudahan_rekreasi) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_kejahatan) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_kejahatan) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_kejahatan) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
							...
							<tr>
								<td>Keamanan terhadap /</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_kebakaran) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_kebakaran) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_kebakaran) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
							...
							<tr>
								<td>Keamanan terhadap /</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_bencana) == 'baik' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_bencana) == 'cukup' ? '&#10003;' : '&#45;'; ?></td>
								<td>&nbsp;</td>
								<td style="border: 1px dotted #808080; width: 20px;" align="center"><?php echo strtolower($tanah->keamanan_terhadap_bencana) == 'kurang' ? '&#10003;' : '&#45;'; ?></td>
							</tr>
							<tr>
		...
		<tr>
			<td style="padding: 0px 0px 0px 0px;">
				<div class="panel" style="width: 100%;">
					...
					<div class="panel-content" style="padding: 0px;">
						<table class="table"  cellpadding="2" cellspacing="0" style="border: 0px; width: 100%;">
							<thead>
								<tr>
									...
									<td style="padding: 0px; width: 30%; border-color: #CCC;">
										<table style="width: 100%;">
											<tr>
												...
												<td style="width: 10px; border: 0px; padding: 5px;" class="text-center">:</td>
											...
											<tr>
												...
												<td style="width: 10px; border: 0px; padding: 5px;" class="text-center; border: 0px; padding: inherit;">:</td>
										...
										<table style="width: 100%; border: 0px;">
											...
											foreach ($list_perubahan_lingkungan as $pl) {
												...
												<tr>
													...
													<td style="border: 1px dotted #808080; width: 30px; text-align: center; padding: inherit;"><?php echo $selected ?></td>
												</tr>
												<?php
												if ( $ipl < $jum_lpl ) {
													?>
	...
	<div class="panel" style="page-break-before: always;">
		...
		<div class="panel-content" style="padding: 0px;">
			<table class="table"  cellpadding="2" cellspacing="0" style="margin-top: 0px; border-left: 0px; border-right: 0px ; border-bottom: 0px; border-top: 0px; width: 100%;">
			<thead>
			<tr>
		...
		<div class="panel-content" style="padding: 15px;">
			<table style="width: 100%; border: 1px dotted #ccc" >
				<tr>
					...
					<td style="width: 550px; font-weight: bold; padding: 5px;">NILAI PASAR TANAH YANG DINILAI</td>
					<td style="width: 10px; padding: 5px;" class="text-center">:</td>
			...
			<div class="panel" style="margin-top: 8px;">
				...
				<div class="panel-content">
					<table style="width: 100%;" border="0" >
						<tr>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Pemberi Tugas</td>
							<td width="10px" align="center">:</td>
							<td valign="top" style="width: 160px"><strong><?php echo $kertas_kerja->debitur; ?></strong></td>
							<td style="width: 20px"></td>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Tanggal Inspeksi</td>
							<td width="10px" align="center">:</td>
							<td valign="top"><?php echo format_datetime($lokasi->tanggal_mulai) ?></td>
						</tr>
						<tr>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Alamat Obyek</td>
							<td width="10px" align="center">:</td>
							<td valign="top" colspan="6"><?php echo $lokasi->alamat; ?></td>
						</tr>
						<tr>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Tipe Bangunan</td>
							<td width="10px" align="center">:</td>
							<td valign="top" style="width: 160px"><strong><?php echo empty($item_bg->tipe_bangunan) ? '-' : $item_bg->tipe_bangunan; ?></strong></td>
							<td style="width: 20px"></td>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Penggunaan saat ini</td>
							<td width="10px" align="center">:</td>
			...
			<div class="panel" style="margin-top: 8px;">
				...
				<div class="panel-content">
					<table style="width: 100%;" border="0" >
						<tr>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Bentuk Arsitek Bangunan</td>
							<td width="10px" align="center">:</td>
			...
			<div class="panel" style="margin-top: 8px;">
				...
				<div class="panel-content">
					<table style="width: 100%;" border="0" >
						<tr>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Saluran listrik PLN</td>
							<td width="10px" align="center">:</td>
							<td valign="top" style="width: 160px"><?php echo empty($item_bg->saluran_listrik_pln) ? '-' : $item_bg->saluran_listrik_pln; ?></td>
							<td style="width: 20px"></td>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 160px">Carport / area parkir</td>
							<td width="10px" align="center">:</td>
			...
			<div class="panel" style="margin-top: 8px;">
				...
				<div class="panel-content" style="padding: 10px 10px 10px 10px">
					<table style="width: 100%; border: 1px dotted #CCC" >
						<tr>
							<td width="5px" align="center"><span style="color: #808080">&#9642;</span></td>
							<td valign="top" style="width: 550px"><strong>NILAI PASAR BANGUNAN</strong></td>
							<td width="10px" align="center">:</td>
	...
	<div class="title" style="page-break-before: always;">PERHITUNGAN NILAI PASAR TANAH</div>

	<br /><br />

	<table class="table" cellspacing="0" cellpadding="0" style="" style="table-layout: fixed;">
		<colgroup>
			<col style="width: 20%">
			<col style="width: 20%">
			<col style="width: 20%">
		...
		<tbody>
			...
			<tr>
				...
				for($i = 0; $i < count($txn_data_banding); $i++){
					...
					?>
				<td style="background: url(<?php echo base_url() ?>asset/file/<?php echo $img_src; ?>) 50% 50% no-repeat; width: 144px; height: 144px;">
			...
			<table style="width: 100%;" align="center" >
				<tr>
					...
					<td valign="top" align="center" style="width: 330px;">
						<div style="display: none;"><?php var_dump($item_image) ?></div>
						<img src="<?=base_url("asset/file/".$multi_file)?>" style="height: 200px; width: 330px; margin-bottom: 10px;"/><br />
