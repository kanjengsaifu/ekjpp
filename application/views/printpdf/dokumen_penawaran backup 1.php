        ...
        <table style="font-family: Century Gothic; font-size: 10pt" border ="0" width="100%">
            ...
            <tr>
                ...
                <td colspan="5" style="vertical-align: top;align: center">
                    <table width="90%"><tr><td>&nbsp;&nbsp;&nbsp;</td><td style="text-align:justify;font-size:11pt;">
            ...
            <tr>
                ...
                <td colspan="6" style="vertical-align: top;text-align: justify;">
                    <table class="table-color" cellpadding="0" cellspacing="0" width="100%" style="border-left: 1px solid #999; border-top: 1px solid #999;">
                        <thead>
                        ...
                        <tbody>
                                ...
                                <tr style="background-color: #C0C0C0">
                                        <td style="padding: 5px 10px; border-bottom: 1px solid #999; border-right: 1px solid #999;" align="right">TOTAL IMBALAN JASA</td>
                                        <td style="padding: 5px 10px; border-bottom: 1px solid #999; border-right: 1px solid #999;" align="right">Rp.  <?=number_format($dokumen_penawaran->biaya)?></td>
                                </tr>
                                <tr style="background-color: #C0C0C0">
                                    <td colspan="2" style="padding: 5px 10px; border-bottom: 1px solid #999; border-right: 1px solid #999;" align="center">Terbilang : 
                                        <?php
                    ...
                    <table width ="100%" style="font-size:10pt;font-family: Century Gothic;">
                        ...
                        if ($lembar_kendali->termin_pembayaran_1 > 0) { ?>
                            <tr valign="top">
                                ...
                                <td>Termin 1 : <?=$lembar_kendali->termin_pembayaran_1?> %</td>
                            </tr>
                        <?php
                        }
                        if ($lembar_kendali->termin_pembayaran_2 > 0) { ?>
                            <tr valign="top">
                                <td><li type="square"></li></td>
                                <td>Termin 2 : <?=$lembar_kendali->termin_pembayaran_2?> %</td>
                            </tr>
                        ...
                        if ($lembar_kendali->termin_pembayaran_3 > 0) { ?>
                            ...
                            <tr valign="top">
                                <td><li type="square"></li></td>
                                <td>Termin 3 : <?=$lembar_kendali->termin_pembayaran_3?> %</td>
                            </tr>
                        ...
                        if ($lembar_kendali->termin_pembayaran_4 > 0) { ?>
                            <tr valign="top">
                                <td><li type="square"></li></td>
                                <td>Termin 4 : <?=$lembar_kendali->termin_pembayaran_4?> %</td>
                            </tr>
                        ...
                        if ($lembar_kendali->termin_pembayaran_5 > 0) { ?> 
                            <tr valign="top">
                                 <td><li type="square"></li></td>
                                 <td>Termin 5 : <?=$lembar_kendali->termin_pembayaran_5?> %</td>
                             </tr>
