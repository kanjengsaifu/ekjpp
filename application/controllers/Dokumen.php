...
class Dokumen extends CI_Controller {
    var $page_title = 'Dokumen';
    var $column_datatable = array('A.id', 'A.nama_klien', 'A.nama_pekerjaan', 'A.jenis_sertifikat', 'A.file_sertifikat', 'A.nama_dokumen_master', 'A.file_dokumen_gabung');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/dokumen/datatable', $data, true);
    ...
    function add($id = 0) {
        ...
        $this->template2->write_view('content', $this->folder.'/dokumen/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
