...
class Laporan extends CI_Controller {
    ...
    var $column_datatable = array('A.id_pekerjaan', 'A.nama_klien', 'A.nama_pekerjaan', 'A.laporan');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/laporan/datatable', $data, true);
    ...
    function add($id = 0) {
        ...
        $this->template2->write_view('content', $this->folder.'/laporan/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
