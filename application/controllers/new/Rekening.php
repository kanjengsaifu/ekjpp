...
class Rekening extends CI_Controller {
    var $page_title = 'Master Rekening';
    var $column_datatable = array('A.id_rekening', 'B.nama', 'A.rekening', 'A.bank');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'Rekening_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/rekening/datatable', $data, true);
    ...
    function add($id = 0) {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                $data_insert = array(
                    ...
                    'rekening' => strip_tags($this->input->post('rekening')),
        ...
        $this->template2->write_view('content', $this->folder.'/rekening/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
