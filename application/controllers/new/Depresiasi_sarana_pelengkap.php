 ...
 */
class Depresiasi_sarana_pelengkap extends CI_Controller {
    var $page_title = 'Master Depresiasi Sarana Pelengkap';
    var $column_datatable = array('A.id', 'B.nama', 'A.sarana_pelengkap', 'A.nilai');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'Depresiasi_sarana_pelengkap_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/depresiasi_sarana_pelengkap/datatable', $data, true);
    ...
    private function valid_form($act = 'add') {
        ...
        $config = array(
            array(
                'field' => 'sarana_pelengkap',
                'label' => 'sarana_pelengkap',
    ...
    function add($id = 0) {
        ...
        $this->template2->write_view('content', $this->folder.'/depresiasi_sarana_pelengkap/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
