...
class Master_ikk extends CI_Controller {
    var $page_title = 'Index Kemahalan Konstruksi';
    var $column_datatable = array('A.ID_KOTAKAB', 'A.ID_PROVINSI', 'A.NAMA_KOTAKAB', 'A.ISACTIVE', 'A.INDEKS');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'Master_ikk_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/master_ikk/datatable', $data, true);
    ...
    function add($id_sub_perusahaan = 0) {
        ...
        $this->template2->write_view('content', $this->folder.'/master_ikk/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
