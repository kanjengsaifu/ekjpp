 ...
 */
class Master_deviasi extends CI_Controller {
    var $page_title = 'Master Deviasi';
    var $column_datatable = array('id_persen_deviasi', 'id_jenis_objek', 'nilai');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'master_deviasi_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/master_deviasi/datatable', $data, true);
    ...
    private function valid_form($act = 'add') {
        ...
        $config = array(
                    array(
                        'field' => 'id_jenis_objek',
                        'label' => 'ID Jenis Objek',
    ...
    function add($id_sub_perusahaan = 0) {
        ...
        $this->template2->write_view('content', $this->folder.'/master_deviasi/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
