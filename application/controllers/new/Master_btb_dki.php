 ...
 */
class Master_btb_dki extends CI_Controller {
    var $page_title = 'Master BTB DKI';
    var $column_datatable = array('A.id', 'A.tipe', 'A.data1', 'A.data2', 'A.data3');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'Master_btb_dki_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/master_btb_dki/datatable', $data, true);
    ...
    function add($id_sub_perusahaan = 0) {
        ...
        $this->template2->write_view('content', $this->folder.'/master_btb_dki/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
