...
class Status_kepemilikan extends CI_Controller {
    var $page_title = 'Status Kepemilikan';
    var $column_datatable = array('A.id', 'A.status_kepemilikan', 'A.kode');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'Status_kepemilikan_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/status_kepemilikan/datatable', $data, true);
    ...
    function add($id = 0) {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                $data_insert = array(
                    'status_kepemilikan' => strip_tags($this->input->post('status_kepemilikan')),
        ...
        $this->template2->write_view('content', $this->folder.'/status_kepemilikan/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
