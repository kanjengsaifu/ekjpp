 ...
 */
class Master_reference extends CI_Controller {
    var $page_title = 'Master Reference';
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'Master_reference_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template2->write_view('content', $this->folder.'/master_reference/datatable', $data, true);
    ...
    function add($id = 0) {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                $data_insert = array(
                    'tipe' => strip_tags($this->input->post('master_deviasi')),
                    'data1' => strip_tags($this->input->post('data1')),
                    'data2' => strip_tags($this->input->post('data2')),
                    'data3' => strip_tags($this->input->post('data3')),
                );
        ...
        $this->template2->write_view('content', $this->folder.'/master_reference/form', $data, true);
        $this->template2->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
