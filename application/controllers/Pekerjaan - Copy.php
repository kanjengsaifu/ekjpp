...
class pekerjaan extends CI_Controller
{
	...
	function tambah($id = null)
	{
		...
		$jenis_laporan 		= $this->formlib->_generate_dropdown_list("jenis_laporan", 2, array("Ringkas", "Lengkap"), array("Ringkas", "Lengkap"),$objek_edit->jenis_laporan, TRUE);
		$keterangan 		= $this->formlib->_generate_input_textarea("keterangan", "Keterangan", $objek_edit->keterangan, TRUE, TRUE);

		$jenis_pemberi_tugas = "<input type='radio' id='jenis_pemberi_tugas_0' name='jenis_pemberi_tugas' value='0' ";  if ($objek_edit->jenis_pemberi_tugas==0){$jenis_pemberi_tugas .="Checked";}  $jenis_pemberi_tugas .="> Klien/Debitur ";
		$jenis_pemberi_tugas .= "<input type='radio' id='jenis_pemberi_tugas_1' name='jenis_pemberi_tugas' value='1' ";  if ($objek_edit->jenis_pemberi_tugas==1){$jenis_pemberi_tugas .="Checked";}  $jenis_pemberi_tugas .="> Bank ";
	    ...
	    $maksud_tujuan 		= $this->formlib->_generate_dropdown_list("maksud_tujuan", 6, array(1,2,3,4,5,6), array("Jaminan/Agunan Kredit", "Penjaminan Utang","Asuransi","Jual Beli","Jual Beli dalam Waktu Terbatas","Agunan yang Diambil Alih Pada Perbankan"),$objek_edit->maksud_tujuan, TRUE);
	...
	function lokasi_edit($id_pekerjaan = "", $id = "")
	{
		...
		if (empty($id))
		{
			...
			$id_jenis_objek	= $this->formlib->_generate_radio_master("mst_jenis_objek", "id_jenis_objek", "id", "nama", "");
	...
	function lembar_kendali_edit($id_pekerjaan = "", $id = "")
	{
		...
		else
		{
			...
			else if ($lembar_kendali->id_status == 18 || $pekerjaan->id_status == 24)
			{
