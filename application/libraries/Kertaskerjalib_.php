...
class kertaskerjalib
{
	...
	function get_textbox($lokasi, $item_field, $keterangan = "")
	{
		...
		{
			$content = "<input type='text' id='textbox_".$item_field->nama."' name='".$name."' class='table_input input_".$item_field->id."_".$keterangan." ".$keterangan."' value='".((set_value(".$name.")) ? set_value(".$name.") : $value)."' data-id-field='".$item_field->id."' data-keterangan='".$keterangan."'>";
		}
		else if($item_field->type == "Number")
		{
			...
			$content = "<input type='number' id='textbox_".$item_field->nama."' name='".$name."' class='table_input number  input_".$item_field->id."_".$keterangan."' value='".((set_value(".$name.")) ? set_value(".$name.") : $value)."' data-id-field='".$item_field->id."' min='".$min."' max='".$max."' data-keterangan='".$keterangan."'>";
		}
		else if($item_field->type == "Date")
		{
			$content = "
			<input type='text' id='textbox_".$item_field->nama."' name='".$name."' class='table_input' value='".((set_value(".$name.")) ? set_value(".$name.") : $value)."' data-id-field='".$item_field->id."' data-date-format='dd-mm-yyyy' data-date-autoclose='true' data-keterangan='".$keterangan."'>
			<script>
		...
		{
			$dropdown = "<select class='table_input input_".$item_field->id."_".$keterangan."' id='textbox_".$item_field->nama."' name='".$name."' data-id-field='".$item_field->id."' data-keterangan='".$keterangan."'>";
		...
		{
			$dropdown = "<select class='table_input' id='textbox_".$item_field->nama."' name='".$name."' data-id-field='".$item_field->id."' data-keterangan='".$keterangan."'>";
			$dropdown .= "<option selected='selected' disabled='disabled'>Select</option>";
		...
		{
			$content = "<textarea id='textbox_".$item_field->nama."' name='".$name."' class='table_input input_".$item_field->id."_".$keterangan."' data-id-field='".$item_field->id."' data-keterangan='".$keterangan."'>".((set_value(".$name.")) ? set_value(".$name.") : $value)."</textarea>";
		}
